...
let gridRowEnd = n => Declaration("gridRowEnd", Int.to_string(n));

let gridRowStart = n => Declaration("gridRowStart", Int.to_string(n));
...
let zIndex = x => Declaration("zIndex", Int.to_string(x));
